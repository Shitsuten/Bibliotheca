...
## 待整理（来自 @Shitsuten 的 stars，筛后 46/71）

**[epiral/bb-browser](https://github.com/epiral/bb-browser)** · TypeScript · ⭐5335  
Your browser is the API. CLI + MCP server for AI agents to control Chrome with your login state.  

**[migratorywhale/stackchan-mcp](https://github.com/migratorywhale/stackchan-mcp)** · C++ · ⭐7  
Give your AI a body. MCP bridge for Stack-chan (M5Stack CoreS3) — speak, listen, see, move, emote.  

**[wusaki0723/play-prompt-kit](https://github.com/wusaki0723/play-prompt-kit)** · ⭐69  

**[N8python/claudesona](https://github.com/N8python/claudesona)** · Python · ⭐68  
Claudesona Emotion Sprites is an unofficial fan extension for claude.ai. It watches normal page text for simple emotion tags such as <claude_happy />, <claude_thoughtful />, and <claude_skeptical />, then replaces each tag with a compact 128x128 transparent claudesona sprite.  

**[chrishutchinson/claude-receipts](https://github.com/chrishutchinson/claude-receipts)** · TypeScript · ⭐590  
Bring receipts from your Claude Code sessions  

**[P0luz/Ombre-Brain](https://github.com/P0luz/Ombre-Brain)** · Python · ⭐298  

**[LucieEveille/kiwi-mem](https://github.com/LucieEveille/kiwi-mem)** · Python · ⭐72  
🥝 AI 伴侣记忆系统 — 向量搜索、记忆热度、Dream 睡眠整合、日历层级摘要，为 AI 陪伴场景而生。  

**[mcncarl/yichen-skills](https://github.com/mcncarl/yichen-skills)** · Python · ⭐213  

**[dankefox/ai-browser-tutorial](https://github.com/dankefox/ai-browser-tutorial)** · ⭐76  
AI浏览器自由教程 - 一只狐狸是怎么学会自己逛推特的 🦊  

**[maillab/cloud-mail](https://github.com/maillab/cloud-mail)** · JavaScript · ⭐9230  
A Cloudflare-based email service  | 基于 Cloudflare 的邮箱服务  | Cloudflare Email 邮箱 Mail  

**[alchaincyf/huashu-design](https://github.com/alchaincyf/huashu-design)** · HTML · ⭐14237  
Huashu Design · HTML-native design skill for Claude Code · Claude Code 里 HTML 原生的设计 skill · 高保真原型 / 幻灯片 / 动画 + 20 设计哲学 + 5 维评审 + MP4 导出 · Agent-agnostic  

**[Seltaa/ReSpark](https://github.com/Seltaa/ReSpark)** · Python · ⭐28  
Your AI companion, locally yours. 🔥  

**[multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills)** · ⭐136482  
A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls.  

**[bailylu/portable-wifi-proxy](https://github.com/bailylu/portable-wifi-proxy)** · Shell · ⭐196  

**[anthropics/claude-desktop-buddy](https://github.com/anthropics/claude-desktop-buddy)** · C++ · ⭐1886  
...
**[JOYCEQL/magic-resume](https://github.com/JOYCEQL/magic-resume)** · TypeScript · ⭐7745  
...
**[anthropics/skills](https://github.com/anthropics/skills)** · Python · ⭐137187  
Public repository for Agent Skills  

**[Joan000-bot/Noe-chat](https://github.com/Joan000-bot/Noe-chat)** · HTML · ⭐11  
Self-hosted AI companion chat system  

**[JCodesMore/ai-website-cloner-template](https://github.com/JCodesMore/ai-website-cloner-template)** · TypeScript · ⭐15040  
Clone any website with one command using AI coding agents  

**[Tosd0/device-event-logger](https://github.com/Tosd0/device-event-logger)** · TypeScript · ⭐8  
An endpoint to log user device events and query through MCP.  

**[haihungle253-boop/travel-raven](https://github.com/haihungle253-boop/travel-raven)** · ⭐6  
A Travel Raven skill for OpenClaw — lets your agent roam the world, traverse history, and wander into fiction.  

**[Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach)** · Python · ⭐19854  
Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.  

**[MemPalace/mempalace](https://github.com/MemPalace/mempalace)** · Python · ⭐52458  
The best-benchmarked open-source AI memory system. And it's free.  

**[breferrari/obsidian-mind](https://github.com/breferrari/obsidian-mind)** · TypeScript · ⭐2573  
An Obsidian vault that gives AI coding agents persistent memory. Claude Code, Codex CLI, Gemini CLI.  

**[alchaincyf/steve-jobs-skill](https://github.com/alchaincyf/steve-jobs-skill)** · ⭐837  
乔布斯.skill — Steve Jobs的认知操作系统。6个心智模型 + 8条决策启发式 + 完整表达DNA。由女娲.skill生成。  

**[open-multi-agent/open-multi-agent](https://github.com/open-multi-agent/open-multi-agent)** · TypeScript · ⭐6188  
...
**[lijigang/ljg-skills](https://github.com/lijigang/ljg-skills)** · HTML · ⭐5117  

**[alchaincyf/nuwa-skill](https://github.com/alchaincyf/nuwa-skill)** · Python · ⭐19799  
你想蒸馏的下一个员工，何必是同事。蒸馏任何人的思维方式——心智模型、决策启发式、表达DNA。Distill how anyone thinks.  

**[mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent)** · Shell · ⭐20678  
...
**[34306/vphone-aio](https://github.com/34306/vphone-aio)** · Shell · ⭐3668  
1 script run the vphone  

**[wuyoscar/ISC-Bench](https://github.com/wuyoscar/ISC-Bench)** · Python · ⭐774  
Internal Safety Collapse: Turning the LLM or an AI Agent into a sensitive data generator.  

**[willibrandon/pixel-plugin](https://github.com/willibrandon/pixel-plugin)** · Shell · ⭐176  
...
**[rullerzhou-afk/clawd-on-desk](https://github.com/rullerzhou-afk/clawd-on-desk)** · JavaScript · ⭐2657  
A pixel desktop pet that watches Claude Code, Codex, Cursor & other AI coding agents — so you don't have to.  

**[affaan-m/ECC](https://github.com/affaan-m/ECC)** · JavaScript · ⭐186738  
The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.  

**[moeru-ai/airi](https://github.com/moeru-ai/airi)** · TypeScript · ⭐39360  
💖🧸 Self hosted, you-owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.  

**[666ghj/BettaFish](https://github.com/666ghj/BettaFish)** · Python · ⭐40959  
微舆：人人可用的多Agent舆情分析助手，打破信息茧房，还原舆情原貌，预测未来走向，辅助决策！从0实现，不依赖任何框架。  

**[BeistMedAI/Paper-List-for-Prototypical-Learning](https://github.com/BeistMedAI/Paper-List-for-Prototypical-Learning)** · ⭐213  
Paper List for Prototypical Learning  

**[openai/gpt-oss](https://github.com/openai/gpt-oss)** · Python · ⭐20106  
gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI  

**[QwenLM/Qwen](https://github.com/QwenLM/Qwen)** · Python · ⭐21166  
The official repo of Qwen (通义千问) chat & pretrained large language model proposed by Alibaba Cloud.  

**[lijiayi-ai/Qwen3-FineTuning-Playground](https://github.com/lijiayi-ai/Qwen3-FineTuning-Playground)** · Python · ⭐128  
一个包含了多种主流大模型微调方案的实战代码库，基于Qwen3系列模型  

**[mlabonne/llm-course](https://github.com/mlabonne/llm-course)** · ⭐79456  
Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.  

**[microsoft/ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)** · Jupyter Notebook · ⭐63647  
